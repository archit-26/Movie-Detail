...
export const Header = () => {
  ...
  return (
    ...
    <nav className="bg-white border-gray-400 border  dark:bg-gray-900">
      ...
      <div id="mobile-nav" className="flex md:order-2">
        ...
        <div id="nav-links" className={`${hidden? "hidden" : ""} items-center justify-between  w-full md:flex md:w-auto md:order-1" id="navbar-search"`}>
          <div className="relative mt-3 md:hidden">
            ...
            <form onSubmit={handleSubmit}>
              <input type="text" id="search-navbar" name="seacrh" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." autoComplete="off"/>
